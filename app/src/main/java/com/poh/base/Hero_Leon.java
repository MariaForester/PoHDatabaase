...
public class Hero_Leon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heroLayout.setImageResource(R.drawable.leon_layout);
        ...
        Firebase heroDescription = new Firebase("https://planet-of-heroes-base.firebaseio.com/Heroes/Leon/Desc");
        Firebase heroPricePlanet = new Firebase("https://planet-of-heroes-base.firebaseio.com/Heroes/Leon/Price/Planetoons");
        Firebase heroPriceSaphire = new Firebase("https://planet-of-heroes-base.firebaseio.com/Heroes/Leon/Price/Saph");
    ...
    private void init() {
        ...
        mPager.setAdapter(new Slide_adapter(Hero_Leon.this, slideArray, text, text2));
