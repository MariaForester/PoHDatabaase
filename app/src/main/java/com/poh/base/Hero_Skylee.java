...
public class Hero_Skylee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heroLayout.setImageResource(R.drawable.skylee_layout);
        ...
        Firebase heroDescription = new Firebase("https://planet-of-heroes-base.firebaseio.com/Heroes/Skylee/Desc");
        Firebase heroPricePlanet = new Firebase("https://planet-of-heroes-base.firebaseio.com/Heroes/Skylee/Price/Planetoons");
        Firebase heroPriceSaphire = new Firebase("https://planet-of-heroes-base.firebaseio.com/Heroes/Skylee/Price/Saph");
    ...
    private void init() {
        ...
        mPager.setAdapter(new Slide_adapter(Hero_Skylee.this, slideArray, text, text2));
