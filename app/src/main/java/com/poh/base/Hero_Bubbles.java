...
public class Hero_Bubbles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heroLayout.setImageResource(R.drawable.bubbles_layout);
        ...
        Firebase heroDescription = new Firebase("https://planet-of-heroes-base.firebaseio.com/Heroes/Bubbles/Desc");
        Firebase heroPricePlanet = new Firebase("https://planet-of-heroes-base.firebaseio.com/Heroes/Bubbles/Price/Planetoons");
        Firebase heroPriceSaphire = new Firebase("https://planet-of-heroes-base.firebaseio.com/Heroes/Bubbles/Price/Saph");
    ...
    private void init() {
        ...
        mPager.setAdapter(new Slide_adapter(Hero_Bubbles.this, slideArray, text, text2));
