...
public class Hero_Dozer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heroLayout.setImageResource(R.drawable.dozer_layout);
    ...
    private void init() {
        ...
        mPager.setAdapter(new Slide_adapter(Hero_Dozer.this, slideArray, text, text2));
