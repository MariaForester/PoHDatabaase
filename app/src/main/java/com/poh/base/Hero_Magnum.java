...
public class Hero_Magnum extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heroLayout.setImageResource(R.drawable.magnum_layout);
        ...
        Firebase heroDescription = new Firebase("https://planet-of-heroes-base.firebaseio.com/Heroes/Magnum/Desc");
        Firebase heroPricePlanet = new Firebase("https://planet-of-heroes-base.firebaseio.com/Heroes/Magnum/Price/Planetoons");
        Firebase heroPriceSaphire = new Firebase("https://planet-of-heroes-base.firebaseio.com/Heroes/Magnum/Price/Saph");
    ...
    private void init() {
        ...
        mPager.setAdapter(new Slide_adapter(Hero_Magnum.this, slideArray, text, text2));
