...
public class Hero_Iffir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heroLayout.setImageResource(R.drawable.iffir_layout);
        ...
        heroName.setText("Iffir");
        TextView heroClass = (TextView) findViewById(R.id.heroClass);
        heroClass.setText("MAGE");
        heroClass.setTextColor(getResources().getColor(R.color.mage));
        ...
        Firebase heroDescription = new Firebase("https://planet-of-heroes-base.firebaseio.com/Heroes/Iffir/Desc");
        Firebase heroPricePlanet = new Firebase("https://planet-of-heroes-base.firebaseio.com/Heroes/Iffir/Price/Planetoons");
        Firebase heroPriceSaphire = new Firebase("https://planet-of-heroes-base.firebaseio.com/Heroes/Iffir/Price/Saph");
    ...
    private void init() {
        ...
        mPager.setAdapter(new Slide_adapter(Hero_Iffir.this, slideArray, text, text2));
